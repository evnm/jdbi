...
public class BuiltInArgumentFactory implements ArgumentFactory {
    ...
    private static Map<Class<?>, ArgBuilder<?>> createInternalBuilders() {
        ...
        register(map, float.class, Types.FLOAT, PreparedStatement::setFloat);
        register(map, Inet4Address.class, Types.OTHER, (p, i, v) -> p.setObject(i, v.getHostAddress(), Types.OTHER));
        register(map, Inet6Address.class, Types.OTHER, (p, i, v) -> p.setObject(i, v.getHostAddress(), Types.OTHER));
